    ...
    return (
        <div>
          <Card className='card'>
            <WorkXPHeader
                avatar={
                  <Avatar aria-label="Recipe" className='avatar' src={"/images/" + this.props.experience.company.logo}>
                  </Avatar>
                }
                action={
                  <IconButton>
            ...
            <CardContent>
              <Typography component="p">
                Work is: {this.props.experience.position} @ {this.props.experience.company.name}
              </Typography>
            </CardContent>
